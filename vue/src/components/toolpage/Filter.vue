                ...
                <b-dropdown-form id="dropfilterform">
                    ...
                    <div class="mb-3" id="filterphase" hidden>
                        <b-form-group v-slot="{ ariaDescribedby }">
                            ...
                            <b-form-radio v-model="uiState.filterOptions.apc" :aria-describedby="ariaDescribedby" value="apc1">Full automatic processing</b-form-radio>
                            <b-form-radio v-model="uiState.filterOptions.apc" :aria-describedby="ariaDescribedby" value="apc2">Check list</b-form-radio>
                            <b-form-radio v-model="uiState.filterOptions.apc" :aria-describedby="ariaDescribedby" value="apc3">Enabled</b-form-radio>
                            <b-form-radio v-model="uiState.filterOptions.apc" :aria-describedby="ariaDescribedby" value="apc4">Ready</b-form-radio>
                            <b-form-radio v-model="uiState.filterOptions.apc" :aria-describedby="ariaDescribedby" value="apc5">No automatic processing</b-form-radio>
                        </b-form-group>
                    </div>
                    <div class="mb-3">
                        <div class="d-grid gap-2">
