...
```
cd existing_repo
git remote add origin https://gitlab.reutlingen-university.de/anuki/metric-catalog-tool.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.reutlingen-university.de/anuki/metric-catalog-tool/-/settings/integrations)
